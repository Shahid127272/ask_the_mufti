...
class FeedsScreen extends StatefulWidget {
  ...
  @override
  State<FeedsScreen> createState() =>
      _FeedsScreenState();
}
class _FeedsScreenState
    extends State<FeedsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.subCategory != null &&
      ...
      questions = questions
          .where(
            (q) => q.subCategory == widget.subCategory,
      )
          .toList();
    }
...
class _QuestionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final subCategory = question.subCategory?.trim() ?? '';
